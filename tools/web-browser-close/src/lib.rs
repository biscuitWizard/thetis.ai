//! Close this conversation's browser context, discarding its cookies, storage and tabs.
//!
...
impl Guest for Component {
    fn describe() -> ToolManifest {
        ToolManifest {
            ...
            description: "Close this conversation's browser context, discarding its cookies, storage and tabs.".to_string(),
    ...
    /// `config_json` is this tool's own `[tools.web-browser-close]` block from
    ...
    fn invoke(
        ...
        sys::log(LogLevel::Debug, &format!("web-browser-close invoked with: {input}"));

        // Replace this with the real implementation.
        Ok(format!("web-browser-close is a stub; it received: {input}"))
    }
}
