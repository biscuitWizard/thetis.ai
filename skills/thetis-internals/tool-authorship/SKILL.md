...
universal = false
tags = ["tools", "tool component", "new_tool", "describe", "invoke", "args schema", "capabilities", "read-only", "tool config", "api key", "wasm32-wasip2", "wit-bindgen", "hot reload", "filesystem", "workspace", "side effects", "tool-group:selfmod", "tool-group:shell"]
version = 2
---
